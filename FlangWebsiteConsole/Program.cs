...
namespace FlangWebsiteConsole
{
        ...
        public static FValue WebPrint(Scope scope, List<FValue> arguments)
        {
            ...
            if (Text is FDictionary Dict)
            {
                if (Pos is FInt Position)
                {
                    ...
                    {
                        ret = Dict.SetIndex(Position, new FString(val.SpagToCsString())); //if it doest exist then make it exist
                    }
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            args = new[]
            {
"--QzoveGFtcHAvaHRkb2NzL3dlYmxlc3Nlbi9sZWVyamFhcjMvZmxhbmdhcGkvb2xkL2luZGV4Mi5mbGFuZz9jc2RlYnVn",
"--aW5kZXgyLmZsYW5nP2NzZGVidWc=",
"--L3dlYmxlc3Nlbi9sZWVyamFhcjMvZmxhbmdhcGkvb2xkL2luZGV4Mi5mbGFuZz9jc2RlYnVn",
"--",
"--eyJjc2RlYnVnIjoiIn0=",
"--W10=",
            };
        ...
        private static string ParseFlang(string input, string filePath, string page,string url,string contentRaw, Dictionary<string, object> GET, Dictionary<string, object> POST)
        {
            ...
            //just always do this caching isnt worth it
